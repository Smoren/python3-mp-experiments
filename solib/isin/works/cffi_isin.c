...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_isin(PyObject *self, PyObject *args)
{
  int64_t * x0;
  int64_t x1;
  int64_t * x2;
...
static const struct _cffi_global_s _cffi_globals[] = {
  { "isin", (void *)_cffi_f_isin, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_isin },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_cffi_isin(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_cffi_isin(void) { return NULL; }
#  else
     initcffi_isin(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_cffi_isin(void)
{
  return _cffi_init("cffi_isin", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initcffi_isin(void)
{
  _cffi_init("cffi_isin", 0x2601, &_cffi_type_context);
}
#endif
